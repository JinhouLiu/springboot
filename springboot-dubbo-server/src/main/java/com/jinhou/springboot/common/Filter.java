package com.jinhou.springboot.common;
import com.jinhou.springboot.utils.DateUtils;
...
public class Filter implements Serializable {
	 ...
	 *            忽略大小写
	 */
	public Filter(String property, Operator operator, Object value, boolean ignoreCase, boolean allowNull) {
		this.property = property;
		this.operator = operator;
		this.value = value;
		this.ignoreCase = ignoreCase;
	 ...
	 *            格式
	 */
	public Filter(String property, Operator operator, Object value, Format format) {
		this.property = property;
		this.operator = operator;
		this.value = value;
		this.format = format;
		if(value instanceof Date && format != null) {
			switch (operator) {
			case ge:
				this.value = DateUtils.getBeginByFormat(format.name(), (Date)value);
				break;
			case le:
				this.value = DateUtils.getEndByFormat(format.name(), (Date)value);
				break;
			default:
				break;
			}
	 ...
	 * @return 大于筛选
	 */
	public static Filter gt(String property, Object value, boolean allowNull) {
		return new Filter(property, Operator.gt, value, DEFAULT_IGNORE_CASE, allowNull);
	}
	 ...
	 * @return 小于筛选
	 */
	public static Filter lt(String property, Object value, boolean allowNull) {
		return new Filter(property, Operator.lt, value, DEFAULT_IGNORE_CASE, allowNull);
	}
	 ...
	 * @return 大于等于筛选
	 */
	public static Filter ge(String property, Object value, Format format) {
		return new Filter(property, Operator.ge, value, format);
	}
	 ...
	 * @return 小于等于筛选
	 */
	public static Filter le(String property, Object value, Format format) {
		return new Filter(property, Operator.le, value, format);
	}
